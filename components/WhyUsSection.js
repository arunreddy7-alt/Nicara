export default function WhyUsSection() {
  return (
    <section className="w-full bg-white pt-8 pb-12 flex flex-col items-center px-4 sm:px-8">
  <h2
    className="text-2xl sm:text-3xl md:text-4xl font-light mb-6 sm:mb-9 mt-10"
  ...
  <p
    ...
    <br className="hidden sm:block" />
    and intimate celebrations, everything we do begins with intention — and ends in feeling.
  </p>
</section>
  );
} 